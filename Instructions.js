 ...
 * 
 * The project runs under github projects. This is where all the tasks are categorised in to three columns
 * first column is "Todo", second is "In progess", and third is "done"
 * 
 * All tasks/issues before started are in the "Todo" column and should be moved to the "In progress tab" when the person has
 * started working on it. This can be done by draggin the task between columns.
 * 
 ...
 * 2. Add short title and detailed information on what the task sould cover
 ...
 * 3. commits shouk be precise/short and understandable
 * 4. Avoid commit large changes. try to commit after every small change so that it's easy to roll back effectively in time
 * 
 */

 /**
  * ===== RESOURCES =====
  * 1. Resurce links can be found on the repo under the Wiki tab and selecting resources page
  * 2. Try to go over all resources for better omparison on what framework to use on the project.
  ...
  */
   ...
   * each others PR once its ready to fasten the devlopment process.
   * 
